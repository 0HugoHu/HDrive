...
func InitialSettings() []model.SettingItem {
	...
	initialSettingItems = []model.SettingItem{
		...
		{Key: conf.SiteTitle, Value: "HDrive", Type: conf.TypeString, Group: model.SITE},
		...
		// style settings
		{Key: conf.Logo, Value: "https://drive.hugohu.site/d/awss3/CDN/logo/landscape/O.svg?sign=PDQDYnKrNGZLRg1k2_CZd1j1CniMzfmySDt5WskTwo0=:0", Type: conf.TypeText, Group: model.STYLE},
		{Key: conf.Favicon, Value: "https://drive.hugohu.site/d/awss3/CDN/logo/single_char/2.svg?sign=kH6mh3PNZ8Vl3dUG1JRFFps7ABZrpEFEa-fY7BR7r-E=:0", Type: conf.TypeString, Group: model.STYLE},
		{Key: conf.MainColor, Value: "#333333", Type: conf.TypeString, Group: model.STYLE},
	...
	"epub": {
		...
		//}`, Type: conf.TypeText, Group: model.PREVIEW},
		{Key: "audio_cover", Value: "https://drive.hugohu.site/d/awss3/CDN/logo/landscape/O.svg?sign=PDQDYnKrNGZLRg1k2_CZd1j1CniMzfmySDt5WskTwo0=:0", Type: conf.TypeString, Group: model.PREVIEW},
